...
vi.mock('@config/index', () => ({
  config: {
    projects: [
      { name: 'Featured-One', tags: [], url: '', description: '', linkText: '' },
    ],
...
vi.mock('../../data/projects.json', () => ({
  default: {
    repos: [
      { name: 'Featured-One', url: '', stars: 0, forks: 0, language: null, topics: [], description: '' },
      { name: 'other-repo', url: '', stars: 5, forks: 0, language: 'TypeScript', topics: [], description: '' },
      { name: 'hammadxcm', url: '', stars: 0, forks: 0, language: null, topics: [], description: '' },
      { name: 'homebrew-tap', url: '', stars: 0, forks: 0, language: null, topics: [], description: '' },
    ],
    downloads: { 'pkg-a': 100 },
  },
}));
