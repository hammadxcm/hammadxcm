...
const config: PortfolioConfig = {
  ...
  about: {
    ...
    philosophy: [
      'Building systems that scale, teams that deliver,',
  ...
  techStack: [
    {
      ...
      items: [
        ...
        { name: 'JavaScript', icon: 'https://techstack-generator.vercel.app/js-icon.svg', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
        { name: 'Tailwind', icon: 'https://skillicons.dev/icons?i=tailwind', url: 'https://tailwindcss.com' },
        { name: 'Sass', icon: 'https://techstack-generator.vercel.app/sass-icon.svg', url: 'https://sass-lang.com' },
        { name: 'Redux', icon: 'https://techstack-generator.vercel.app/redux-icon.svg', url: 'https://redux.js.org' },
        { name: 'Angular', icon: 'https://skillicons.dev/icons?i=angular', url: 'https://angular.dev' },
      ],
    },
    {
      title: 'Backend',
      emoji: '\u2699\uFE0F',
      items: [
        { name: 'Ruby', icon: 'https://skillicons.dev/icons?i=ruby', url: 'https://www.ruby-lang.org' },
        { name: 'Rails', icon: 'https://skillicons.dev/icons?i=rails', url: 'https://rubyonrails.org' },
        { name: 'Node.js', icon: 'https://skillicons.dev/icons?i=nodejs', url: 'https://nodejs.org' },
        { name: 'GraphQL', icon: 'https://techstack-generator.vercel.app/graphql-icon.svg', url: 'https://graphql.org' },
        { name: 'Python', icon: 'https://techstack-generator.vercel.app/python-icon.svg', url: 'https://www.python.org' },
        { name: 'NestJS', icon: 'https://skillicons.dev/icons?i=nestjs', url: 'https://nestjs.com' },
        { name: 'Django', icon: 'https://techstack-generator.vercel.app/django-icon.svg', url: 'https://www.djangoproject.com' },
        { name: 'Nginx', icon: 'https://techstack-generator.vercel.app/nginx-icon.svg', url: 'https://nginx.org' },
        { name: 'REST API', icon: 'https://techstack-generator.vercel.app/restapi-icon.svg', url: 'https://restfulapi.net' },
        { name: 'BullMQ', icon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Ccircle cx='24' cy='24' r='22' fill='%23e53935'/%3E%3Cpath d='M10 16c-1-3 0-7 2-9 1 2 3 4 6 4M38 16c1-3 0-7-2-9-1 2-3 4-6 4' stroke='%23fff' stroke-width='2.5' fill='none' stroke-linecap='round'/%3E%3Ccircle cx='17' cy='22' r='2.5' fill='%23fff'/%3E%3Ccircle cx='31' cy='22' r='2.5' fill='%23fff'/%3E%3Cellipse cx='24' cy='31' rx='7' ry='4.5' fill='%23c62828'/%3E%3Ccircle cx='21' cy='31' r='1.5' fill='%23ffcdd2'/%3E%3Ccircle cx='27' cy='31' r='1.5' fill='%23ffcdd2'/%3E%3C/svg%3E", url: 'https://docs.bullmq.io' },
        { name: 'Sidekiq', icon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Ccircle cx='24' cy='24' r='22' fill='%23b1003e'/%3E%3Cpath d='M15 32c0-7 4-10 9-16 5 6 9 9 9 16 0 6-4 10-9 10s-9-4-9-10z' fill='%23e74c3c'/%3E%3Cpath d='M20 33c0-3 2-5 4-8 2 3 4 5 4 8 0 3-2 5-4 5s-4-2-4-5z' fill='%23f1c40f'/%3E%3C/svg%3E", url: 'https://sidekiq.org' },
      ],
    },
    {
      title: 'Databases',
      ...
      items: [
        ...
        { name: 'MySQL', icon: 'https://techstack-generator.vercel.app/mysql-icon.svg', url: 'https://www.mysql.com' },
        { name: 'Redis', icon: 'https://skillicons.dev/icons?i=redis', url: 'https://redis.io' },
        { name: 'SQLite', icon: 'https://skillicons.dev/icons?i=sqlite', url: 'https://www.sqlite.org' },
        { name: 'Prisma', icon: 'https://skillicons.dev/icons?i=prisma', url: 'https://www.prisma.io' },
      ],
    },
    {
      title: 'Cloud & DevOps',
      ...
      items: [
        ...
        { name: 'Azure', icon: 'https://skillicons.dev/icons?i=azure', url: 'https://azure.microsoft.com' },
        { name: 'Docker', icon: 'https://techstack-generator.vercel.app/docker-icon.svg', url: 'https://www.docker.com' },
        { name: 'K8s', icon: 'https://techstack-generator.vercel.app/kubernetes-icon.svg', url: 'https://kubernetes.io' },
        { name: 'Git', icon: 'https://skillicons.dev/icons?i=git', url: 'https://git-scm.com' },
        { name: 'GitHub', icon: 'https://techstack-generator.vercel.app/github-icon.svg', url: 'https://github.com' },
        { name: 'Heroku', icon: 'https://skillicons.dev/icons?i=heroku', url: 'https://www.heroku.com' },
      ],
    },
    {
      title: 'Testing',
      emoji: '\uD83E\uDDEA',
      items: [
        { name: 'Jest', icon: 'https://techstack-generator.vercel.app/jest-icon.svg', url: 'https://jestjs.io' },
        { name: 'Vitest', icon: 'https://skillicons.dev/icons?i=vitest', url: 'https://vitest.dev' },
        { name: 'RSpec', icon: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/rspec/rspec-original.svg', url: 'https://rspec.info' },
        { name: 'Testing Lib', icon: 'https://techstack-generator.vercel.app/testinglibrary-icon.svg', url: 'https://testing-library.com' },
        { name: 'ESLint', icon: 'https://techstack-generator.vercel.app/eslint-icon.svg', url: 'https://eslint.org' },
        { name: 'Prettier', icon: 'https://techstack-generator.vercel.app/prettier-icon.svg', url: 'https://prettier.io' },
        { name: 'rubocop-hk', icon: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Cdefs%3E%3ClinearGradient id='a' x1='0' y1='0' x2='1' y2='1'%3E%3Cstop offset='0' stop-color='%23cc342d'/%3E%3Cstop offset='1' stop-color='%23e55039'/%3E%3C/linearGradient%3E%3C/defs%3E%3Cpath d='M24 2L4 14v20l20 12 20-12V14z' fill='url(%23a)'/%3E%3Cpath d='M24 10l-12 7v14l12 7 12-7V17z' fill='none' stroke='%23fff' stroke-width='1.5' opacity='.4'/%3E%3Cpath d='M24 16l-6 3.5v7L24 30l6-3.5v-7z' fill='%23fff' opacity='.9'/%3E%3Cpath d='M24 20l-2 1.2v2.4l2 1.2 2-1.2v-2.4z' fill='%23cc342d'/%3E%3C/svg%3E", url: 'https://rubygems.org/gems/rubocop-hk' },
      ],
    },
    {
      title: 'AI & Tools',
      ...
      items: [
        ...
        { name: 'WebStorm', icon: 'https://skillicons.dev/icons?i=webstorm', url: 'https://www.jetbrains.com/webstorm' },
        { name: 'Webpack', icon: 'https://techstack-generator.vercel.app/webpack-icon.svg', url: 'https://webpack.js.org' },
        { name: 'Storybook', icon: 'https://techstack-generator.vercel.app/storybook-icon.svg', url: 'https://storybook.js.org' },
        { name: 'Swift', icon: 'https://techstack-generator.vercel.app/swift-icon.svg', url: 'https://www.swift.org' },
        { name: 'Stripe', icon: 'https://skillicons.dev/icons?i=stripe', url: 'https://stripe.com' },
        { name: 'Daemon OS', icon: 'daemon-icon.svg', url: 'https://github.com/hammadxcm/daemon-os', isLocal: true },
      ],
    },
  ],
  ...
  projects: [
    {
      ...
      description: 'Merged PR to <strong>rails/rails</strong> &mdash; Fixed Ruby 4.0 delegator warning in ActiveModel/ActiveRecord.',
    ...
    },
    {
      ...
      description: 'Published npm package &mdash; TUI dashboard with prayer times, i18n &amp; notifications.',
    ...
    },
    {
      ...
      description: 'Published RubyGem &mdash; 2,800+ downloads. Modern RuboCop config for Ruby &amp; Rails projects.',
    ...
    },
    {
      ...
      description: 'React zoom component &mdash; 8 stars, 748+ downloads. TypeScript with 7 releases.',
    ...
    },
    {
      ...
      description: 'Animated CSS border effects &mdash; React, Vue, Next.js &amp; Svelte with live demo.',
    ...
    },
    {
      ...
      description: 'macOS MCP server for AI agent computer-use &mdash; gives AI eyes &amp; hands on your Mac.',
  ...
  certifications: [
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://skillicons.dev/icons?i=rails', width: 44, alt: 'Hotwire' },
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://raw.githubusercontent.com/devicons/devicon/master/icons/rspec/rspec-original.svg', width: 44, alt: 'RSpec' },
      category: 'Testing',
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://techstack-generator.vercel.app/ts-icon.svg', width: 50, alt: 'TypeScript' },
      category: 'Languages',
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://techstack-generator.vercel.app/mysql-icon.svg', width: 50, alt: 'MySQL' },
      category: 'Databases',
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://techstack-generator.vercel.app/github-icon.svg', width: 50, alt: 'Git & GitHub' },
      category: 'Tools',
    ...
    },
    {
      ...
      badge: { type: 'image', src: 'https://techstack-generator.vercel.app/python-icon.svg', width: 50, alt: 'Python' },
      category: 'Python',
